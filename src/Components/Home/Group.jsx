...
function Group() {
  return (
    <div className='flex flex-col justify-center items-center font-cardFont'>
      ...
      <h1 className='text-center font-bold text-orange-600 text-5xl w-9/12 mb-4'>Find your community. Set Goals.
      ...
      <div className='grid gap-x-10 gap-y-4 lg:grid-cols-2 justify-center items-center'>
        ...
        <div>
            <h1 className='text-4xl font-semibold font-cardFont text-orange-500'>Stronger together 💪</h1>
